...
export default function UGVNoCercaEB() {
    ...
    const fetchCoords = async () => {
      try {
        const [uavRes, ebRes] = await Promise.all([
          axios.get('http://192.168.5.80:3000/coordenadasUGV'),
  ...
  const injectedJS = coords
    ...
    L.marker(uav).addTo(map).bindPopup("📍 UGV").openPopup();
...
L.marker([midLat, midLon], {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>UGV NO ESTÁ CERCA DE{"\n"}LA ESTACIÓN BASE</Text>
